...
<tr><td><img src="resources/img/items/${x.product_img}.gif">
</td><td>
<a href="productDetails?gCode=${x.product_code}">${x.product_name }</a><br>
<span class="label_deduct">${x.product_context }</span></td><td>${x.product_price }</td>
...
<input type="hidden" class="cart_no" value="${x.cart_no}">
 ...
 <table id="table1">
		 <tr>
				...
				<td>
				    <input type="text" name="order_name" id="user_name" class="form" value="${mDTO.user_name }" readonly maxlength="20">
