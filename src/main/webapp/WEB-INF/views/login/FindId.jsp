...
<script type="text/javascript" src="../resources/js/login_Buyer.js"></script>
	...
	<form action="/app/login/findId" method="post" id="userForm">
	<br>이름   
        <input type="text" name="user_name" id="name" class="form-control onlyHangul" id="name" data-rule-required="true" maxlength="4">
    	<br><span id="name_message" style="color:red"></span><br>
		<!-- 브라우저 통해 보이는 부분 --> 
          이메일  <input type="text" class="form-control"  data-rule-required="true" maxlength="24" id="email1" name="email1">@
        <input type="text" class="form-control" data-rule-required="true" maxlength="320" id="email2" name="email2">
  		<br><select  id="selectEmail" class="form-control" data-rule-required="true" >
       	...
       	<br>
		<button type="submit" class="form-control btn btn-outline-success"> 아이디 찾기 </button>
	</form>	
	<br>
	</div>
	<% }else{%>
	<div>
		...
		<span style="font-weight: bold"> <%=request.getAttribute("findId") %></span>
	<%}%>
	</div>
<div class="d-flex justify-content-center">
<br><br>
