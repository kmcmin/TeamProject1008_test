...
<jsp:include page="../common/top.jsp" flush="true"/> <br>
        ...
        <!-- //////////여기까진 공통적으로 들어감 -->
            ...
            <div class="divCsInfo">
                ...
                <br>
               <!--   <button type="button" class="btn btn-success BtnTel">
                 	챗봇 문의하기
               </button> -->
            
            </div><!--divCsInfo-->
            <div class="row csImgList" >
                <div class="col-md-2 csImg" onclick="location.href='#'">
                 ...
                 </div> <div class="col-md-2 csImg" onclick="location.href='/app/noticeUI'">
                    <div class="innerDivimg">
                     <!--공지사항 아이콘 코드-->
                 ...
                 <div class="col-md-2 csImg" onclick="location.href='/app/FAQUI'">
                    <div class="innerDivimg">
                        <!--faq 아이콘 코드-->
                 ...
                 <div class="col-md-2 csImg" onclick="location.href='/app/QnAListUI'">
                    <div class="innerDivimg">
                     <!--1:1문의 아이콘 코드-->
