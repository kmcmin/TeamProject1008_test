      ...
      <div id="footer" class="css-1i60c0e ebj6vxr5">
         <div class="css-j6zuv6 ebj6vxr4">
            <div class="css-0 eam2qm511">
               <h2 class="css-4iyald eam2qm510">파머스 행복센터</h2>
               <strong class="css-9jqcug eam2qm58"> 1644-1234 <span
                     ...
                     <div class="css-1lxmeik eam2qm52">
                        ...
                        <svg width="1" height="10" viewBox="0 0 1 10" fill="none"
                           xmlns="http://www.w3.org/2000/svg" class="css-w0fx7a eam2qm50">
                                            <line x1="0.5"
                              y1="2.18557e-08" x2="0.5" y2="10" stroke="#ccc"></line>
                                        </svg>
               ...
               <div class="css-vtjvf eam2qm51">비회원 문의 : gmldnjs077@naver.com
               </div>
            </div>
            <div class="css-1fttcpj ebj6vxr3">
               <ul class="css-17hse91 e13nap1l2">
                  <li class=" css-slkv2p e13nap1l1"><a href="/introduce"
                     target="_self" class="css-1tfhwyj e13nap1l0">파머스 소개</a></li>
               ...
               <div class="css-bz7mfs ebj6vxr2">
                  법인명 (상호) : 주식회사 파머스 <span class="css-1ekjygq ebj6vxr1"></span>
                  사업자등록번호 : 1234-5678 <a
                     href="https://www.ftc.go.kr/bizCommPop.do?wrkr_no=2618123567&amp;apv_perm_no="
                     target="_blank" rel="noreferrer" class="css-1tby8gd ebj6vxr0">사업자정보
                     확인</a> <br /> 통신판매업 : 제 2023-서울강남- Acon호<br /> 주소 : 서울특별시 강남구 테헤란로
                  <span class="css-1ekjygq ebj6vxr1"></span> 대표이사 : 강망고, 이정희<br /> 채용문의
                  : gmldnjs077@naver.com <br />팩스: 000 - 1234 - 5678
               </div>
               <ul class="css-zjik7 ek68y4g1">
                  ...
                  <a href="https://www.youtube.com/channel/UCfpdjL5pl-1qKT7Xp4UQzQg"
                     target="_blank" rel="noreferrer" class="css-9ipg3 ek68y4g0">
                     <img src="https://res.kurly.com/pc/ico/1810/ico_youtube.png"
                     alt="컬리 유튜브 바로가기" />
                  </a>
               </ul>
            </div>
